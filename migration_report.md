...
- применила pipe‑оператор в местах последовательной обработки данных, чтобы сократить количество промежуточных переменных и сделать цепочки действий более читаемыми;
